...
export const HeldConnoteListResults = ({ HeldConnotes, ...rest }) => {
  ...
  function newHeldConnote(HeldConnotes){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/newHeldConnote', HeldConnotes).then(response => {
  ...
  function updateSingleHeldConnote(HeldConnote){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/updateHeldConnote', HeldConnote).then(response => {
    ...
    function deleteSingleHeldConnote(HeldConnote){
      ...
      const res =  axios.post('https://127.0.0.1:5050/api/rules/deleteHeldConnote', HeldConnote).then(response => {
