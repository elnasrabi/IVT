...
export const AMPortfolioListResults = ({ AMPortfolios, ...rest }) => {
  ...
  function newAMPortfolio(AMPortfolios){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newAMPortfolio', AMPortfolios).then(response => {
  ...
  function updateSingleAMPortfolio(AMPortfolio){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateAMPortfolio', AMPortfolio).then(response => {
    ...
    function deleteSingleAMPortfolio(AMPortfolio){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteAMPortfolio', AMPortfolio).then(response => {
