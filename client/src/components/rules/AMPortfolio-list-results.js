...
export const AMPortfolioListResults = ({ AMPortfolios, ...rest }) => {
  ...
  function newAMPortfolio(AMPortfolios){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newAMPortfolio', AMPortfolios).then(response => {
  ...
  function updateSingleAMPortfolio(AMPortfolio){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updateAMPortfolio', AMPortfolio).then(response => {
    ...
    function deleteSingleAMPortfolio(AMPortfolio){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deleteAMPortfolio', AMPortfolio).then(response => {
