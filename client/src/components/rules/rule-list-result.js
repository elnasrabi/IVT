...
export const RuleListResults = ({ Rules, ...rest }) => {
  ...
  //   const res =  axios.post('https://127.0.0.1:5050/api/rules/newRule', Rules).then(response => {
  ...
  function updateSingleRule(Rule){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/updateRule', Rule).then(response => {
    ...
    function deleteSingleRule(Rule){
      ...
      const res =  axios.post('https://127.0.0.1:5050/api/rules/deleteRule', Rule).then(response => {
