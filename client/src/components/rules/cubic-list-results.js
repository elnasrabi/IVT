...
export const CubicListResults = ({ Cubics, ...rest }) => {
  ...
  function newCubic(Cubic){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newCubic', Cubic).then(response => {
  ...
  function updateSingleCubic(Cubic){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateCubic', Cubic).then(response => {
    ...
    function deleteSingleCubic(Cubic){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteCubic', Cubic).then(response => {
