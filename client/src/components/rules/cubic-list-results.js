...
export const CubicListResults = ({ Cubics, ...rest }) => {
  ...
  function newCubic(Cubic){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newCubic', Cubic).then(response => {
  ...
  function updateSingleCubic(Cubic){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updateCubic', Cubic).then(response => {
    ...
    function deleteSingleCubic(Cubic){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deleteCubic', Cubic).then(response => {
