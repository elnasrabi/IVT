...
export const FuelListResults = ({ Fuels, ...rest }) => {
  ...
  function newFuel(Fuel){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newFuel', Fuel).then(response => {
  ...
  function updateSingleFuel(Fuel){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateFuel', Fuel).then(response => {
    ...
    function deleteSingleFuel(Fuel){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteFuel', Fuel).then(response => {
