...
export const FuelListResults = ({ Fuels, ...rest }) => {
  ...
  function newFuel(Fuel){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newFuel', Fuel).then(response => {
  ...
  function updateSingleFuel(Fuel){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updateFuel', Fuel).then(response => {
    ...
    function deleteSingleFuel(Fuel){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deleteFuel', Fuel).then(response => {
