...
export const RuleOptionListResults = ({ RuleOptions, ...rest }) => {
  ...
  function newRuleOption(RuleOption){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/newRuleOption', RuleOption).then(response => {
  ...
  function updateSingleRuleOption(RuleOption){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/updateRuleOption', RuleOption).then(response => {
    ...
    function deleteSingleRuleOption(RuleOption){
      ...
      const res =  axios.post('https://127.0.0.1:5050/api/rules/deleteRuleOption', RuleOption).then(response => {
