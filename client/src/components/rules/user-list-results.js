...
export const UserListResults = ({ Users, ...rest }) => {
  ...
  function newUser(Users){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newUser', Users).then(response => {
  ...
  function updateSingleUser(User){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateUser', User).then(response => {
    ...
    function deleteSingleUser(User){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteUser', User).then(response => {
