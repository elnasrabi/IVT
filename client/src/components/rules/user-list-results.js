...
export const UserListResults = ({ Users, ...rest }) => {
  ...
  function newUser(Users){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newUser', Users).then(response => {
  ...
  function updateSingleUser(User){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updateUser', User).then(response => {
    ...
    function deleteSingleUser(User){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deleteUser', User).then(response => {
