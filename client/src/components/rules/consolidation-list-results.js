...
export const ConsoloditionListResults = ({ Consoloditions, ...rest }) => {
  ...
  function newConsolodition(Consoloditions){
    ...
    const res =  axios.post('http://localhost:5050/api/rules/newConsolodition', Consoloditions).then(response => {
  ...
  function updateSingleConsolodition(Consolodition){
    ...
    const res =  axios.post('http://localhost:5050/api/rules/updateConsolodition', Consolodition).then(response => {
    ...
    function deleteSingleConsolodition(Consolodition){
      ...
      const res =  axios.post('http://localhost:5050/api/rules/deleteConsolodition', Consolodition).then(response => {
