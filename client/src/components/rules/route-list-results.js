...
export const RouteListResults = ({ Routes, ...rest }) => {
  ...
  function newRoute(Route){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newRoute', Route).then(response => {
  ...
  function updateSingleRoute(Route){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updateRoute', Route).then(response => {
    ...
    function deleteSingleRoute(Route){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deleteRoute', Route).then(response => {
