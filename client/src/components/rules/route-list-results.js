...
export const RouteListResults = ({ Routes, ...rest }) => {
  ...
  function newRoute(Route){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newRoute', Route).then(response => {
  ...
  function updateSingleRoute(Route){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateRoute', Route).then(response => {
    ...
    function deleteSingleRoute(Route){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteRoute', Route).then(response => {
