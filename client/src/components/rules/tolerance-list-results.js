...
export const ToleranceListResults = ({ Tolerances, ...rest }) => {
  ...
  function newTolerance(Tolerances){
    ...
    const res =  axios.post('http://localhost:5050/api/rules/newTolerance', Tolerances).then(response => {
  ...
  function updateSingleTolerance(Tolerance){
    ...
    const res =  axios.post('http://localhost:5050/api/rules/updateTolerance', Tolerance).then(response => {
    ...
    function deleteSingleTolerance(Tolerance){
      ...
      const res =  axios.post('http://localhost:5050/api/rules/deleteTolerance', Tolerance).then(response => {
