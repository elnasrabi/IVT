...
export const ToleranceListResults = ({ Tolerances, ...rest }) => {
  ...
  function newTolerance(Tolerances){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/newTolerance', Tolerances).then(response => {
  ...
  function updateSingleTolerance(Tolerance){
    ...
    const res =  axios.post('https://127.0.0.1:5050/api/rules/updateTolerance', Tolerance).then(response => {
    ...
    function deleteSingleTolerance(Tolerance){
      ...
      const res =  axios.post('https://127.0.0.1:5050/api/rules/deleteTolerance', Tolerance).then(response => {
    ...
    <Card>
      ...
      <MaterialTable
        ...
        columns={[
          ...
          { title: "TOLERANCE(Weight)", field: "P4_TOLERANCE",type:"numeric" },
          { title: "TOLERANCE(Cost)", field: "P5_TOLERANCE",type:"numeric" },
          { title: "TOLERANCE(Weekly Cost)", field: "P6_TOLERANCE",type:"numeric" },
