...
export const ToleranceListResults = ({ Tolerances, ...rest }) => {
  ...
  function newTolerance(Tolerances){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/newTolerance', Tolerances).then(response => {
  ...
  function updateSingleTolerance(Tolerance){
    ...
    const res =  axios.post('http://afs-web01:4545/rules/updateTolerance', Tolerance).then(response => {
    ...
    function deleteSingleTolerance(Tolerance){
      ...
      const res =  axios.post('http://afs-web01:4545/rules/deleteTolerance', Tolerance).then(response => {
