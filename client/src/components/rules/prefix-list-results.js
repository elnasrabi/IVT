...
export const PrefixeListResults = ({ Prefixes, ...rest }) => {
  ...
  function newPrefix(prefix){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/newPrefix', prefix).then(response => {
  ...
  function updateSinglePrefix(prefix){
    ...
    const res =  axios.post('http://localhost:5051/api/rules/updatePrefix', prefix).then(response => {
    ...
    function deleteSinglePrefix(prefix){
      ...
      const res =  axios.post('http://localhost:5051/api/rules/deletePrefix', prefix).then(response => {
