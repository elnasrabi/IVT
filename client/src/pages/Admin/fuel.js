...
function Fuels(){ 
  ...
  const address = `https://127.0.0.1:5050/api/rules/getFuels`;
...
//      rejectUnauthorized: false
//    });
//    const result =  axios.get('https://127.0.0.1:5050/api/rules/getFuels',{ httpsAgent: agent });
...
//     const result = await axios.get('https://127.0.0.1:5050/api/rules/getFuels',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           FuelData: data
