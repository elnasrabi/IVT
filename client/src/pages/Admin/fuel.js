...
function Fuels(){ 
  ...
  const address = `http://localhost:5051/api/rules/getFuels`;
 ...
 try {
   ...
   const result =  axios.get('http://localhost:5051/api/rules/getFuels',{ httpsAgent: agent });
...
//     const result = await axios.get('http://localhost:5051/api/rules/getFuels',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           FuelData: data
