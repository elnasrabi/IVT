...
function Prefixes(){ 
  ...
  const address = `http://localhost:5051/api/rules/getPrefixes`;
 ...
 try {
   ...
   const result =  axios.get('http://localhost:5051/api/rules/getPrefixes',{ httpsAgent: agent });
...
//     const result = await axios.get('http://localhost:5051/api/rules/getPrefixes',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           prefixData: data
