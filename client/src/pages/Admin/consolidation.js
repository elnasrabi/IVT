...
function Consoloditions(){ 
  ...
  const address = `https://127.0.0.1:5050/api/rules/getConsoloditions`;
...
//      rejectUnauthorized: false
//    });
//    const result =  axios.get('https://127.0.0.1:5050/api/rules/getConsoloditions',{ httpsAgent: agent });
...
//     const result = await axios.get('https://127.0.0.1:5050/api/rules/getConsoloditions',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           ConsoloditionData: data
