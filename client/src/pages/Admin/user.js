...
function Users(){ 
  ...
  const address = `https://127.0.0.1:5050/api/rules/getUsers`;
...
//      rejectUnauthorized: false
//    });
//    const result =  axios.get('https://127.0.0.1:5050/api/rules/getUsers',{ httpsAgent: agent });
...
//     const result = await axios.get('https://127.0.0.1:5050/api/rules/getUsers',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           UserData: data
