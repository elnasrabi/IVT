...
function Routes(){ 
  ...
  const address = `http://localhost:5051/api/rules/getRoutes`;
  ...
  try {
    ...
    const result =  axios.get('http://localhost:5051/api/rules/getRoutes',{ httpsAgent: agent });
...
//       rejectUnauthorized: false
//     });
//     const result = await axios.get('http://localhost:5051/api/rules/getRoutes',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           RouteData: data
