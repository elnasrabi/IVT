...
function Cubics(){ 
  ...
  const address = `http://localhost:5051/api/rules/getCubics`;
 ...
 try {
   ...
   const result =  axios.get('http://localhost:5051/api/rules/getCubics',{ httpsAgent: agent });
...
//     const result = await axios.get('http://localhost:5051/api/rules/getCubics',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           cubicData: data
