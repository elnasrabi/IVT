...
function Cubics(){ 
  ...
  const address = `https://127.0.0.1:5050/api/rules/getCubics`;
...
//      rejectUnauthorized: false
//    });
//    const result =  axios.get('https://127.0.0.1:5050/api/rules/getCubics',{ httpsAgent: agent });
...
//     const result = await axios.get('https://127.0.0.1:5050/api/rules/getCubics',{ httpsAgent: agent });
//     const data = result.data;
//     return {
//         props: {
//           cubicData: data
